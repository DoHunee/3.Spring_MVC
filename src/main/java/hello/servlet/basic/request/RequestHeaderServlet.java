...
public class RequestHeaderServlet extends HttpServlet {
  ...
  private void printStartLine(HttpServletRequest request) {
    ...
    // http://localhost:8080/request-header?name=hi
    // username=hi
  ...
  private void printHeaderUtils(HttpServletRequest request) {
    ...
    System.out.println("request.getServerPort() = " + request.getServerPort()); // request.getServerPort() = 8080
    System.out.println();
  ...
  private void printEtc(HttpServletRequest request) {
    ...
    System.out.println("request.getRemotePort() = " + request.getRemotePort()); // request.getRemotePort() = 54305
    System.out.println();
    System.out.println("[Local 정보]");
    System.out.println("request.getLocalName() = " + request.getLocalName()); // request.getLocalName() = localhost
